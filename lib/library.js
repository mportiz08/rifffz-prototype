(function() {
  ...
  Library = (function(_super) {
    ...
    Library.prototype.addAlbum = function(info) {
      var resource, song, _i, _j, _len, _len2, _ref, _ref2, _results;
      ...
      for (_j = 0, _len2 = _ref2.length; _j < _len2; _j++) {
        song = _ref2[_j];
        _results.push(this.setVal("" + resource + ":song:" + (util.slugify(song.name)) + ":audio", song.path));
      }
      return _results;
    };

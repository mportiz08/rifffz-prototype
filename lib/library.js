(function() {
  ...
  Library = (function(_super) {
    ...
    Library.prototype.addAlbum = function(album) {
      ...
      this.client.set(resource, album.name);
      this.client.set("" + resource + ":year", album.year);
      this.client.set("" + resource + ":cover", album.cover);
      _ref = album.songs;
      _results = [];
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        song = _ref[_i];
        _results.push(this.client.rpush("" + resource + ":songs:" + (util.slugify(song)), song));
      }
      return _results;
    };
